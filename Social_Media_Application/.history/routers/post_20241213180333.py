...
async def create_posts(title: str = Form(...),content: str = Form(...),published: bool = Form(True),image: UploadFile = File(None),  # Optional image filedb: Session = Depends(get_db),
